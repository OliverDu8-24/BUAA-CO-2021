...
module stall(
    ...
    wire E_stall_rs = ((E_lrm ? D_rs_addr : E_GRFA3 == D_rs_addr) && D_rs_addr != 0) && (E_Tnew > D_Tuse_rs);
    wire E_stall_rt = ((E_lrm ? D_rt_addr : E_GRFA3 == D_rt_addr) && D_rt_addr != 0) && (E_Tnew > D_Tuse_rt);

    wire M_stall_rs = ((M_lrm ? D_rs_addr : M_GRFA3 == D_rs_addr) && D_rs_addr != 0) && (M_Tnew > D_Tuse_rs);
    wire M_stall_rt = ((M_lrm ? D_rt_addr : M_GRFA3 == D_rt_addr) && D_rt_addr != 0) && (M_Tnew > D_Tuse_rt);
