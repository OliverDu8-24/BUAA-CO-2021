...
`define half_word           mem[Addr[11:2]][(16*Addr[1] + 15) -: 16]
`define byte                mem[Addr[11:2]][(8*Addr[1:0] + 7) -: 8]
`define half_word_sign      mem[Addr[11:2]][16*Addr[1] + 15]
`define byte_sign           mem[Addr[11:2]][8*Addr[1:0] + 7]
