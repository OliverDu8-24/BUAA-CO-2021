...
`define WDSel_jap       3'b100
`define WDSel_pc4       3'b101
...
`define MDU_mfhi    4'b0010
`define MDU_mflo    4'b0011
`define MDU_mthi    4'b0100
`define MDU_mtlo    4'b0101
`define MDU_multu   4'b0110
`define MDU_divu    4'b0111
`define MDU_madd    4'b1000
`define MDU_maddu   4'b1001
`define MDU_msub    4'b1010
`define MDU_msubu   4'b1011
...
`define op_lwer     6'b111111
`define op_lhonez   6'b111110
