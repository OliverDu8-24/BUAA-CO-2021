...
#endif
static const char *ng0 = "F:/MyWorkspace/Computer_Organization/P7/P7_L0_CPU - For Test/mips_CP0.v";
static int ng1[] = {0, 0};
...
LAB16:    t63 = (t0 + 8320);
    ...
    *((unsigned int *)t73) = (t75 | t69);
    xsi_driver_vfirst_trans(t63, 0, 29U);
    t76 = (t0 + 7936);
    *((int *)t76) = 1;
...
LAB12:    xsi_vlog_unsigned_bit_combine(t3, 30, t16, 30, t62, 30);
    goto LAB16;
...
LAB21:    t31 = (t0 + 1528U);
    ...
    *((unsigned int *)t31) = (t39 & 1073741823U);
    t40 = ((char*)((ng3)));
    memset(t41, 0, 8);
    xsi_vlog_unsigned_minus(t41, 30, t30, 30, t40, 30);
    goto LAB22;
...
LAB25:    xsi_vlog_unsigned_bit_combine(t16, 30, t41, 30, t46, 30);
    goto LAB29;
