...
#endif
static const char *ng0 = "F:/MyWorkspace/Computer_Organization/P7/P7_L0_CPU - For Test/D_NPC.v";
...
LAB73:    memcpy(t157, t136, 8);

LAB74:    memset(t118, 0, 8);
    t189 = (t157 + 4);
...
LAB85:    t196 = (t118 + 4);
    t197 = *((unsigned int *)t118);
    t198 = *((unsigned int *)t196);
    t199 = (t197 || t198);
    if (t199 > 0)
        goto LAB86;

LAB87:    t219 = *((unsigned int *)t118);
    t220 = (~(t219));
...
LAB89:    if (*((unsigned int *)t196) > 0)
        goto LAB90;

LAB91:    if (*((unsigned int *)t118) > 0)
        goto LAB92;

LAB93:    memcpy(t117, t223, 8);
...
LAB86:    t200 = (t0 + 1688U);
    ...
    *((unsigned int *)t208) = t217;
    xsi_vlog_mul_concat(t207, 14, 1, t205, 1U, t210, 1);
    xsi_vlogtype_concat(t203, 32, 32, 3U, t207, 14, t206, 16, t204, 2);
    memset(t218, 0, 8);
    xsi_vlog_unsigned_add(t218, 32, t202, 32, t203, 32);
    goto LAB87;
...
LAB108:    if (*((unsigned int *)t224) > 0)
        goto LAB109;

LAB110:    memcpy(t223, t273, 8);

LAB111:    goto LAB89;

LAB90:    xsi_vlog_unsigned_bit_combine(t117, 32, t218, 32, t223, 32);
    goto LAB94;

LAB92:    memcpy(t117, t218, 8);
    goto LAB94;
...
LAB103:    t255 = ((char*)((ng3)));
    ...
    *((unsigned int *)t258) = t262;
    ...
    t264 = (t263 >> 28);
    *((unsigned int *)t256) = t264;
    t265 = *((unsigned int *)t258);
    *((unsigned int *)t258) = (t265 & 15U);
    t266 = *((unsigned int *)t256);
    *((unsigned int *)t256) = (t266 & 15U);
    xsi_vlogtype_concat(t254, 32, 32, 3U, t258, 4, t257, 26, t255, 2);
    goto LAB104;

LAB105:    t271 = (t0 + 1848U);
    t272 = *((char **)t271);
    t271 = ((char*)((ng2)));
    memset(t273, 0, 8);
...
LAB107:    xsi_vlog_unsigned_bit_combine(t223, 32, t254, 32, t273, 32);
    goto LAB111;

LAB109:    memcpy(t223, t254, 8);
    goto LAB111;
...
extern void work_m_00000000002194573028_3650585529_init()
{
	static char *pe[] = {(void *)Cont_29_0,(void *)Cont_37_1};
	xsi_register_didat("work_m_00000000002194573028_3650585529", "isim/mips_txt_isim_beh.exe.sim/work/m_00000000002194573028_3650585529.didat");
